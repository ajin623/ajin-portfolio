...
learningSignals: {
eyebrow: "Letzter akademischer Schwerpunkt",
title: "Woran ich im zweiten Semester gearbeitet habe.",
description:
"Diese Bereiche prägten meine letzten Module und halfen mir, Business-Konzepte mit praktischen Projekten zu verbinden.",
items: [
{
id: "ai-practice",
...
value: "01",
text:
"Ich untersuchte, wie Daten und AI-unterstützte Methoden Operations, Supply-Chain-Planung, Prozesstransparenz und Business-Entscheidungen verbessern können.",
},
{
id: "llm",
label: "Sprachmodelle und Prompting",
value: "02",
text:
"Ich beschäftigte mich mit dem Verhalten von Sprachmodellen, Prompt Design, Evaluation, Retrieval und kontrollierten Workflow-Konzepten.",
},
{
id: "data",
label: "Programmierung und Datenanalyse",
value: "03",
text:
"Ich arbeitete mit Python, Datensätzen, Evaluationsmethoden, Dashboards und praktischen Datenanalyse-Aufgaben.",
},
{
id: "strategy",
...
value: "04",
text:
"Ich untersuchte, wie Unternehmen Technologieeinführung mit Business-Strategie, Prozessen und organisatorischer Veränderung verbinden.",
},
{
id: "ethics",
...
value: "05",
text:
"Ich beschäftigte mich mit rechtlichen, ethischen, Governance- und Risikofragen bei der verantwortungsvollen Nutzung von AI-Systemen.",
},
],
},
...
value: "Zwei Semester abgeschlossen",
},
{
label: "Fokus",
...
eyebrow: "Kontakt",
title:
"Ich suche Möglichkeiten, bei denen ich lernen, beitragen und praktische Erfahrung entwickeln kann.",
description:
"Wenn meine Projekte und meine Richtung zu Ihrer Arbeit passen, freue ich mich über eine Nachricht.",
emailText: "E-Mail",
